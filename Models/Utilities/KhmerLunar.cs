...
namespace Models.Utilities
{
    ...
    {
        /*
        * Thank to project ".net-khmer-lunar"
        * Github: https://github.com/nhoemchenda/.net-khmer-lunar
        * cam-cc.org has been taken down, please visit https://khmer-calendar.tovnah.com/calendar/
        * There are some modifications in this class.
        * Edited by: KOY Sokleang
        */
        ...
        public static string getKhmerDay(DateTime dt)
        {
            string khDay = "";
            switch (dt.DayOfWeek)
            {
                case DayOfWeek.Sunday: khDay = "អាទិត្យ"; break;
                case DayOfWeek.Monday: khDay = "ចន្ទ"; break;
                case DayOfWeek.Tuesday: khDay = "អង្គារ"; break;
                case DayOfWeek.Wednesday: khDay = "ពុធ"; break;
                case DayOfWeek.Thursday: khDay = "ព្រហស្បត្តិ៍"; break;
                case DayOfWeek.Friday: khDay = "សុក្រ"; break;
                case DayOfWeek.Saturday: khDay = "សៅរ៍"; break;
                default: khDay = ""; break;
            }
            return khDay;
        }
        ...
        public static string getKhmerLunarString(DateTime srcDate)
        {
            ...
            string s = "";
            string khDay = getKhmerDay(srcDate);
            string enDay = convertToKhmerNum(srcDate.Day.ToString("00"));
            string enMonth = Helper.tranMonth(srcDate.Month);
            string enYear = convertToKhmerNum(srcDate.Year.ToString());
            if (enText.Length == 6)
            {
        ...
        {
            // in controller use srcDate with default value DateTime.Now
        ...
        public static string getKhmerLunarCode(DateTime srcDate)
        {
            ...
            DateTime newYearDay = new DateTime(srcDate.Year, 4, tmpNewYearDay); // khmer new year
